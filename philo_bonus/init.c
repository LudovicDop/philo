...
/*   Updated: 2024/03/28 12:18:14 by ldoppler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo_bonus.h"

void	init_variable_bis(int nbre_of_philo, t_philo **philo, t_rules **rules)
{
	int	i;
...
void	init_variable(t_philo **philo, int argc, char **argv, t_rules **rules)
{
	...
	*rules = malloc(sizeof(t_rules));
	...
	init_variable_bis(nbre_of_philo, philo, rules);
}
